...
start_kb = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text='Меню'),KeyboardButton(text= 'О магазине')],
...
start_kb3.attach(start_kb2).row(KeyboardButton(text='Оставить отзыв'))
